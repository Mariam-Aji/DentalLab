        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImpressionStage = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    TargetLabId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LabScanSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LabScanSlots_Labs_LabId",
                        column: x => x.LabId,
                        principalTable: "Labs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabScanSlotId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LabScanSlotId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScanVisitRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScanVisitRequests_LabScanSlots_LabScanSlotId",
                        column: x => x.LabScanSlotId,
                        principalTable: "LabScanSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ScanVisitRequests_LabScanSlots_LabScanSlotId1",
                        column: x => x.LabScanSlotId1,
                        principalTable: "LabScanSlots",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScanVisitRequests_LabScanSlotId",
                table: "ScanVisitRequests",
                column: "LabScanSlotId");

            migrationBuilder.CreateIndex(
                name: "IX_ScanVisitRequests_LabScanSlotId1",
                table: "ScanVisitRequests",
                column: "LabScanSlotId1",
                unique: true,
                filter: "[LabScanSlotId1] IS NOT NULL");
